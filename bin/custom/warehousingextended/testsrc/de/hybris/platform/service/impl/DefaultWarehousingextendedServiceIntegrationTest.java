...
import de.hybris.platform.service.impl.DefaultWarehousingextendedService;
 ...
 */
@IntegrationTest
public class DefaultWarehousingextendedServiceIntegrationTest extends ServicelayerBaseTest
{
	@Resource
	...
	{
		// given
		final String logoCode = "warehousingextendedPlatformLogo";

		// when
		final String logoUrl = warehousingextendedService.getHybrisLogoUrl(logoCode);
