...
/**
 * This is the extension manager of the Warehousingextended extension.
 */
public class WarehousingextendedManager extends GeneratedWarehousingextendedManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(WarehousingextendedManager.class);
	 ...
	 */
	public static WarehousingextendedManager getInstance()
	{
		return (WarehousingextendedManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(WarehousingextendedConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public WarehousingextendedManager() // NOPMD 
	{
		LOG.debug("constructor of WarehousingextendedManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of WarehousingextendedManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of WarehousingextendedManager called, current tenant: {}", getTenant().getTenantID());
	}
