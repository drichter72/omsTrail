 ...
 * --- Generated at 24.04.2018 14:31:52                         ---
 * ----------------------------------------------------------------
 *  
 * [y] hybris Platform
 *  
...
/**
 * Generated class for type <code>OmsencoreManager</code>.
 */
@SuppressWarnings({"deprecation","unused","cast","PMD"})
public abstract class GeneratedOmsencoreManager extends Extension
{
	...
	{
		return (Boolean)item.getProperty( ctx, OmsencoreConstants.Attributes.ConsignmentProcess.DONE);
	}
	...
	{
		item.setProperty(ctx, OmsencoreConstants.Attributes.ConsignmentProcess.DONE,value);
	}
	...
	{
		return OmsencoreConstants.EXTENSIONNAME;
	}
	...
	{
		return (Boolean)item.getProperty( ctx, OmsencoreConstants.Attributes.ConsignmentProcess.WAITINGFORCONSIGNMENT);
	}
	...
	{
		item.setProperty(ctx, OmsencoreConstants.Attributes.ConsignmentProcess.WAITINGFORCONSIGNMENT,value);
	}
	...
	{
		return (EnumerationValue)item.getProperty( ctx, OmsencoreConstants.Attributes.ConsignmentProcess.WAREHOUSECONSIGNMENTSTATE);
	}
	...
	{
		item.setProperty(ctx, OmsencoreConstants.Attributes.ConsignmentProcess.WAREHOUSECONSIGNMENTSTATE,value);
	}
