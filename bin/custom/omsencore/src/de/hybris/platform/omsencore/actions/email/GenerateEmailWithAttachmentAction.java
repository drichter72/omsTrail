 ...
 */
package de.hybris.platform.omsencore.actions.email;
...
public class GenerateEmailWithAttachmentAction extends AbstractSimpleDecisionAction
{
			...
			final String propertyName)
	{
		...
		LOG.debug(String.format("Found [%s] documents for return process to be sent to customers", returnMedia.getCode()));
		return returnMedia;
	}
