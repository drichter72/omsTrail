 ...
 *
 */
package de.hybris.platform.omsencore.actions.consignment;
...
public class ProcessConsignmentPreFulfillmentActionTest
{
	...
	{
		private static final Logger LOGGER = Logger.getLogger(FirstConsignmentPreFulfillmentStrategy.class);
	...
	{
		private static final Logger LOGGER = Logger.getLogger(SecondConsignmentPreFulfillmentStrategy.class);
	...
	{
		private static final Logger LOGGER = Logger.getLogger(ThirdConsignmentPreFulfillmentStrategy.class);
