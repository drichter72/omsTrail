...
public class ReturnIntegrationTest extends BaseAcceleratorSourcingIntegrationTest
{
			...
			throws RetryLaterException, InterruptedException, ImpExException
	{
		...
		importCsv("/omsencore/test/impex/email-content.impex", WarehousingTestConstants.ENCODING);
		importCsv("/omsencore/test/impex/email-content_en.impex", WarehousingTestConstants.ENCODING);
