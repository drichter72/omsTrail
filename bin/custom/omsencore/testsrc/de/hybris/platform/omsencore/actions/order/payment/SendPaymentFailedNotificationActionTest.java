 ...
 *
 */
package de.hybris.platform.omsencore.actions.order.payment;
...
import de.hybris.platform.omsencore.actions.order.payment.SendPaymentFailedNotificationAction;
...
public class SendPaymentFailedNotificationActionTest
{
	...
	/**
	 * Test method for
	 * {@link de.hybris.platform.omsencore.actions.order.SendPaymentFailedNotificationAction#executeAction(OrderProcessModel)}
	 * .
	 */
	@Test
