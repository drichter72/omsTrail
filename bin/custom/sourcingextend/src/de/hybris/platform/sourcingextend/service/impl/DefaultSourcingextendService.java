...
public class DefaultSourcingextendService implements SourcingextendService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultSourcingextendService.class);
	...
	{
		return DefaultSourcingextendService.class.getResourceAsStream("/sourcingextend/sap-hybris-platform.png");
	}
