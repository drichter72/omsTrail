 ...
 */
package de.hybris.platform.sourcingextend.jalo;
...
/**
 * This is the extension manager of the Sourcingextend extension.
 */
public class SourcingextendManager extends GeneratedSourcingextendManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SourcingextendManager.class);
	 ...
	 */
	public static SourcingextendManager getInstance()
	{
		return (SourcingextendManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SourcingextendConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SourcingextendManager() // NOPMD 
	{
		LOG.debug("constructor of SourcingextendManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of SourcingextendManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SourcingextendManager called, current tenant: {}", getTenant().getTenantID());
	}
